  ...
  return (
    <>
      ...
      <div className='px-20 pb-5'>
        <div>
          <h1 className='text-[#0AA01B] mt-2'>Kategori</h1>
          <div className='mt-2'>
            <div className='bg-slate-200 w-[60%] max-h-max overflow-hidden relative rounded-xl shadow-2xl'>
              <img
              ...
              <div className='absolute bottom-5 left-5 p-2 text-white w-[70%]'>
                ...
                <span className='text-sm font-semibold cursor-pointer'>oleh : susorno</span>
              </div>
            </div>
          </div>
        </div>
